import './index.scss';
import {useDeleteBannerMutation, useGetAllBannersQuery, usePostCreateBannerMutation} from "../../services/usersApi.jsx";
...
function BannerPanel() {
    ...
    const [postCreateBanner] = usePostCreateBannerMutation();
            ...
            render: (_, record) => (
                <div style={{
                    ...
                    <img
                        ...
                        src={baseURLBanner + record?.imageName}
                        alt="Product"
                    />
                </div>
            ),
